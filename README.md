...
Here's the Git urls format, followed by examples:
    ...
    git+https://gitlab.com/one-touch-pipeline/weskit/helm-deployment?ref=REDACTED
...
- **using ssh**: Start a [ssh-agent daemon](https://help.github.com/articles/REDACTED/#REDACTED)
